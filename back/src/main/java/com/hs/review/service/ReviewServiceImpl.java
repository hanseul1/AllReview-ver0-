...
public class ReviewServiceImpl implements ReviewService{
	...
	/** _id로 특정 리뷰 정보 검색 */
	public Review searchById(ObjectId _id) {
		return mongoTemplate.findById(_id, Review.class, "review");
	}
	
	/** 제품 번호로 리뷰 리스트 검색 */
	public List<Review> searchByProduct(String model){
	...
	/** 카테고리로 리뷰 리스트 검색 */
	public List<Review> searchByCategory(String category){
	...
	public List<Review> searchByKeywords(Map<String, Object> data){
